...
# for small sample size dataset. k = 5
...
#STEP 2: Imputing 
if (max(noMissingPerSample0,na.rm=TRUE)>=3000) print("max # of missing value per sample over 3000")
...
datMethUsed0 = data.frame(t(impute.knn(data=t(datMethUsed0), k=5, rowmax=.6)$data))
